...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('profiles', '0005_alter_userfullnameemail_options'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Pending'), (1, 'Accepted'), (2, 'Shipped'), (3, 'Delivered'), (4, 'Delivery Failed'), (5, 'Cancelled')], default=0)),
