...
class Product(models.Model):
    ...
    image_1 = models.ImageField(
        null=True,
        blank=True,
        help_text="This is the first image" "that site users would see",
    )
    ...
    image_2_alt = models.CharField(
        max_length=50, null=True, blank=True, help_text="Image-2 alt text"
    )
    image_3 = models.ImageField(null=True, blank=True)
    image_3_alt = models.CharField(
        max_length=50, null=True, blank=True, help_text="Image-3 alt text"
    )
    image_url = models.URLField(max_length=1024, null=True, blank=True)
    image_url_alt = models.CharField(
        max_length=50, null=True, blank=True, help_text="Image url alt text"
    )
